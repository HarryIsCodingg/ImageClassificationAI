...
class CNN(nn.Module):
    ...
    def __init__(self, device):
        ...
        # The output of the convolutional layers initially has dimensions 64x25088, which caused a mismatch error with the input expected by the fully connected layer.
        # Calculating the correct number of features which is passed to the first fully connected layer.
